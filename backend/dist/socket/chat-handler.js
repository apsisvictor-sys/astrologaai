...
exports.handleChatSubscribe = handleChatSubscribe;
exports.handleChatSendMessage = handleChatSendMessage;
exports.handleChatTyping = handleChatTyping;
exports.handleChatCancelGeneration = handleChatCancelGeneration;
...
async function checkRateLimit(userId, tier) {
    ...
    const status = await (0, queryLimit_1.checkQueryLimit)(userId, tier);
    return {
...
async function incrementRateLimit(userId, tier) {
    await (0, queryLimit_1.incrementQueryCount)(userId, tier);
}
// ============================================
 ...
 */
async function handleChatSubscribe(socket, data) {
 ...
 */
async function handleChatSendMessage(socket, data) {
 ...
 */
async function handleChatTyping(socket, data) {
 ...
 */
async function handleChatCancelGeneration(socket, data) {
    const { conversationId } = data;
    const userId = socket.userId;
 ...
 */
async function handleChatUnsubscribe(socket, data) {
    const { conversationId } = data;
