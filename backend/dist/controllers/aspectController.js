...
exports.getSpecificAspect = getSpecificAspect;
exports.getAspectMatrix = getAspectMatrix;
...
async function getAspects(req, res) {
    try {
        ...
        if (type && typeof type === 'string') {
            aspects = aspects.filter((a) => a.aspect.toLowerCase() === type.toLowerCase());
        }
        if (planet && typeof planet === 'string') {
            aspects = aspects.filter((a) => a.planet1.toLowerCase() === planet.toLowerCase() ||
                a.planet2.toLowerCase() === planet.toLowerCase());
        }
        if (nature && typeof nature === 'string') {
            aspects = aspects.filter((a) => a.nature.toLowerCase() === nature.toLowerCase());
        }
...
async function getSpecificAspect(req, res) {
    try {
        ...
        const aspect = aspects.find((a) => (a.planet1.toLowerCase() === planet1.toLowerCase() &&
...
//# sourceMappingURL=aspectController.js.map