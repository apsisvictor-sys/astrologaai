...
exports.generateNatalChart = generateNatalChart;
exports.getNatalChart = getNatalChart;
exports.deleteNatalChart = deleteNatalChart;
exports.recalculateNatalChart = recalculateNatalChart;
exports.shareNatalChart = shareNatalChart;
exports.getSharedNatalChart = getSharedNatalChart;
...
async function deleteNatalChart(req, res) {
    try {
        ...
        // Delete the chart
        const result = await prisma_1.prisma.birthChart.deleteMany({
            where: { birthProfileId: profileId },
        });
        if (result.count === 0) {
            res.status(404).json({
...
async function recalculateNatalChart(req, res) {
    try {
        ...
        await prisma_1.prisma.birthChart.deleteMany({
            where: { birthProfileId: profileId },
        });
        // Prepare birth data for calculation
        const birthDate = new Date(birthProfile.birthDate);
...
async function shareNatalChart(req, res) {
    try {
        ...
        await redis_1.redisClient.setEx(`chart_share:${shareToken}`, expiresIn, JSON.stringify(shareData));
        // Generate share URL
...
async function getSharedNatalChart(req, res) {
    try {
        ...
        const shareDataStr = await redis_1.redisClient.get(`chart_share:${token}`);
        if (!shareDataStr) {
            res.status(404).json({
                success: false,
...
//# sourceMappingURL=natalChartController.js.map