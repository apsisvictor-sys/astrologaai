...
exports.listBirthProfiles = listBirthProfiles;
exports.getBirthProfile = getBirthProfile;
exports.createBirthProfile = createBirthProfile;
exports.updateBirthProfile = updateBirthProfile;
exports.deleteBirthProfile = deleteBirthProfile;
exports.searchLocationsHandler = searchLocationsHandler;
exports.getRegenerationStatus = getRegenerationStatus;
exports.getChartHistory = getChartHistory;
...
async function listBirthProfiles(req, res) {
    try {
        ...
        const profiles = await prisma_1.prisma.birthProfile.findMany({
            where: { userId },
...
async function getBirthProfile(req, res) {
    try {
        ...
        const profile = await prisma_1.prisma.birthProfile.findFirst({
            where: { id, userId },
            include: {
                birthChart: true,
            },
...
async function createBirthProfile(req, res) {
    try {
        ...
        if (!(0, geocoding_1.validateCoordinates)(input.latitude, input.longitude)) {
            res.status(400).json({
                success: false,
                error: {
                    code: 'VALIDATION_ERROR',
        ...
        // Check profile limit
        const existingCount = await prisma_1.prisma.birthProfile.count({
            where: { userId },
        });
        ...
        const timezone = input.timezone ||
            (0, geocoding_1.getTimezoneFromCoordinates)(input.latitude, input.longitude);
        // Create the profile
        const profile = await prisma_1.prisma.birthProfile.create({
            data: {
                userId,
...
async function updateBirthProfile(req, res) {
    try {
        ...
        const existing = await prisma_1.prisma.birthProfile.findFirst({
            where: { id, userId },
            include: {
                birthChart: true,
            },
        ...
        if ((input.latitude !== undefined || input.longitude !== undefined) && !input.timezone) {
            ...
            timezone = (0, geocoding_1.getTimezoneFromCoordinates)(lat, lon);
        }
        // Check if birth data actually changed (to determine if we need to regenerate chart)
        const birthDataChanged = birthDate !== undefined ||
        ...
        if (birthDataChanged && existing.birthChart) {
            await prisma_1.prisma.chartHistory.create({
                data: {
        ...
        // Update the profile
        const profile = await prisma_1.prisma.birthProfile.update({
            where: { id },
            data: {
...
async function deleteBirthProfile(req, res) {
    try {
        ...
        await prisma_1.prisma.birthProfile.delete({
            where: { id },
        });
...
async function searchLocationsHandler(req, res) {
    try {
        ...
        const locations = await (0, geocoding_1.searchLocations)(q, limitNum);
        res.json({
            success: true,
            data: { locations },
        });
...
async function getRegenerationStatus(req, res) {
    try {
        ...
        const chart = await prisma_1.prisma.birthChart.findFirst({
...
async function getChartHistory(req, res) {
    try {
        ...
        const totalCount = profile.birthChart
            ? await prisma_1.prisma.chartHistory.count({
...
//# sourceMappingURL=birthDataController.js.map