...
exports.getChartAnalysis = getChartAnalysis;
exports.getPlanetAnalysis = getPlanetAnalysis;
exports.getHouseAnalysis = getHouseAnalysis;
const prisma_1 = require("../utils/prisma");
const chart_analysis_1 = require("../services/chart-analysis");
/**
...
async function getChartAnalysis(req, res) {
    try {
        ...
        // Get the chart
        const chartRecord = await prisma_1.prisma.birthChart.findFirst({
        ...
        const analysis = (0, chart_analysis_1.analyzeChart)(chartData);
...
async function getPlanetAnalysis(req, res) {
    try {
        ...
        const planet = analysis.planets.find((p) => p.planet.toLowerCase() === planetName.toLowerCase());
        if (!planet) {
            res.status(404).json({
                success: false,
...
//# sourceMappingURL=chartAnalysisController.js.map