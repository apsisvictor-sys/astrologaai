...
exports.isResetDay = isResetDay;
exports.resetMonthlyQueryCounters = resetMonthlyQueryCounters;
exports.archiveOldUsageRecords = archiveOldUsageRecords;
exports.initializeUserUsageRecord = initializeUserUsageRecord;
exports.runScheduledReset = runScheduledReset;
...
async function resetMonthlyQueryCounters() {
    ...
    try {
        ...
        const usersWithUsage = await prisma_1.prisma.usageRecord.findMany({
            where: {
                month: previousMonth,
                user: {
                    tier: 'FREE',
        ...
        for (const record of usersWithUsage) {
            try {
                ...
                const existingRecord = await prisma_1.prisma.usageRecord.findUnique({
                    where: {
                        userId_month: {
        ...
        const freeUsersWithoutRecord = await prisma_1.prisma.user.findMany({
            where: {
                tier: 'FREE',
                NOT: {
                    usageRecords: {
...
async function archiveOldUsageRecords(monthsToKeep = 12) {
    ...
    try {
        ...
        const result = await prisma_1.prisma.usageRecord.deleteMany({
            where: {
                month: {
                    lt: cutoffMonth,
                },
...
//# sourceMappingURL=monthly-reset.js.map