...
function createTestChart(planets, rising, mc) {
    const defaultPlanet = (name) => ({
        name,
        sign: 'Aries',
        signBg: 'Овен',
        degree: 0,
...
describe('Position-Based Cache Key Generation', () => {
    ...
    test('should include all major planets in cache key', () => {
        ...
        const key = (0, astrology_1.generatePositionBasedCacheKey)(chart);
