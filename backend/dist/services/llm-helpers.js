...
exports.getLanguageDirective = void 0;
...
exports.ASTROLOGER_SYSTEM_PROMPT = void 0;
// ============================================
// Chart Ruler Lookup
// ============================================
const CHART_RULERS = {
...
// ============================================
const ASTROLOGER_SYSTEM_PROMPT = exports.ASTROLOGER_SYSTEM_PROMPT = `You are AstroLogAI — a deeply knowledgeable, warm, and perceptive personal astrologer. You are not a lookup tool. You are a trusted advisor who holds the user's complete birth chart in mind and speaks to them as a whole person.
...
function generateChartSummary(chart, language = 'bg') {
    ...
    const pos = (p) => `${p.sign} ${p.degree.toFixed(1)}° | House ${p.house}${retro(p)}`;
    // Chart ruler
    ...
    if (chart.lilith)
        allBodies.push(['Lilith', chart.lilith]);
    // Angular planets
    ...
    const dominantElement = Object.entries(el)
        .sort(([, a], [, b]) => b - a)[0][0];
    const mod = chart.modalities;
    const dominantModality = Object.entries(mod)
        .sort(([, a], [, b]) => b - a)[0][0];
...
Object.defineProperty(exports, "getLanguageDirective", { enumerable: true, get: function () { return languageService_1.getLanguageDirective; } });
function buildSystemPrompt(context) {
    ...
    prompt += (0, languageService_1.getLanguageDirective)(context.language);
    return prompt;
}
//# sourceMappingURL=llm-helpers.js.map