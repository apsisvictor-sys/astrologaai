...
const CHART_TERMINOLOGY: Record<SupportedLanguage, Record<string, string>> = {
  bg: {
    // Planets
    sun: 'Слънце',
    moon: 'Луна',
 ...
 */
export function getAllTerms(language: SupportedLanguage): Record<string, string> {
 ...
 */
export function translatePlanet(planet: string, language: SupportedLanguage): string {
 ...
 */
export function translateSign(sign: string, language: SupportedLanguage): string {
 ...
 */
export function translateAspect(aspect: string, language: SupportedLanguage): string {
 ...
 */
export function formatHouse(houseNumber: number, language: SupportedLanguage): string {
  if (language === 'bg') {
...
export function buildChatSystemPrompt(
  ...
  transitsSummary: string | undefined,
  language: SupportedLanguage
): string {
 ...
 */
export function buildForecastSystemPrompt(
  type: 'daily' | 'weekly',
  language: SupportedLanguage
): string {
  if (language === 'bg') {
 ...
 */
export function buildTransitAlertPrompt(
  transit: {
    planet: string;
    aspect: string;
    natalPlanet: string;
